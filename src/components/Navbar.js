...
const Navbar = () => {
  ...
  const updateTheme = () => {
    ...
    if (document.body.classList.contains('darkmode')) {
      root.style.setProperty('--base-color', '#333');
      root.style.setProperty('--text-color', '#fff');
      root.style.setProperty('--secondary-text', '#aaa');
      root.style.setProperty('--base-variant', '#444');
    } else {
      root.style.setProperty('--base-color', '#fff');
      root.style.setProperty('--text-color', '#000');
      root.style.setProperty('--secondary-text', '#555');
      root.style.setProperty('--base-variant', '#ddd');
    }
  };
